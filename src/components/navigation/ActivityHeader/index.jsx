...
const ActivityHeader = ({ showActivity = true }) => {
  ...
  return (
    <div className="mt-3 flex h-14 items-center justify-between border-t border-gray-300 ps-6 pe-6 text-sm dark:border-gray-700">
        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuItem
              ...
              className="text-md cursor-pointer p-3 font-semibold text-gray-900 hover:bg-gray-100 dark:text-gray-100 dark:hover:bg-gray-700"
            >
      ...
      <button className="ml-auto text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300">
        Xem hoạt động
      </button>
    </div>
  );
